...
public class RenderPWRDebris extends Render<PWRDebrisEntity> {
	...
	public static class Meshes {
		static ResourceLocation res(String s) {
			return new ResourceLocation("leafia", s);
		}
		...
		static final WaveFrontObjectVAO channel3x = getVAO(res("models/leafia/pwrdebris/channel3x.obj"));
		static final WaveFrontObjectVAO channel1x = getVAO(res("models/leafia/pwrdebris/channel1x.obj"));
		...
		static final WaveFrontObjectVAO control_frame = getVAO(res("models/leafia/pwrdebris/control_frame.obj"));
		static final WaveFrontObjectVAO control_rod = getVAO(res("models/leafia/pwrdebris/control_rod.obj"));

		static final WaveFrontObjectVAO concrete = getVAO(res("models/leafia/pwrdebris/concrete_unwrap.obj"));
		static final WaveFrontObjectVAO blank = getVAO(res("models/leafia/pwrdebris/blank_unwrap.obj"));
		static final WaveFrontObjectVAO shrap = getVAO(res("models/leafia/pwrdebris/shrapnel.obj"));
	}
